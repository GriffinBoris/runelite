...
class RSCombatHelper {
    fun clickPunch(): Boolean {
        ...
        val punch = Alfred.clientThread.invokeOnClientThread { Alfred.api.widgets.getWidget(WidgetInfo.COMBAT_STYLE_ONE) } ?: return false
        Alfred.mouse.leftClick(punch.bounds)
        return true
    }
    ...
    fun clickKick(): Boolean {
        Alfred.api.tabs.clickCombatTab()
        Alfred.sleep(200, 400)
        val punch = Alfred.clientThread.invokeOnClientThread { Alfred.api.widgets.getWidget(WidgetInfo.COMBAT_STYLE_TWO) } ?: return false
        Alfred.mouse.leftClick(punch.bounds)
        return true
    }
    ...
    fun clickBlock(): Boolean {
        Alfred.api.tabs.clickCombatTab()
        Alfred.sleep(200, 400)
        val punch = Alfred.clientThread.invokeOnClientThread { Alfred.api.widgets.getWidget(WidgetInfo.COMBAT_STYLE_FOUR) } ?: return false
        Alfred.mouse.leftClick(punch.bounds)
        return true
    }
    ...
    fun clickAutoRetaliate(): Boolean {
        Alfred.api.tabs.clickCombatTab()
        Alfred.sleep(200, 400)
        val punch = Alfred.clientThread.invokeOnClientThread { Alfred.api.widgets.getWidget(WidgetInfo.COMBAT_AUTO_RETALIATE) } ?: return false
        Alfred.mouse.leftClick(punch.bounds)
        return true
    }
